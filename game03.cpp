...
void game03::on_pushButton_1_clicked()
{
...
void game03::paintEvent(QPaintEvent* event){
...
void game03::keyPressEvent(QKeyEvent *event)
{
    int step = 10;
    switch (event->key()) {
    case Qt::Key_W:
...
void game03::endgame1(){
    ...
    if(sunHP <= 0){
        ...
        if(score <= 150){
            ...
            ui->label_6->setStyleSheet("border-image: url(:/img/stars_03.png)");
        }
        else if(score >300 && score <= 450){
            ui->label_6->setStyleSheet("border-image: url(:/img/stars_02.png)");
        }
        else if(score > 450){
            ui->label_6->setStyleSheet("border-image: url(:/img/stars_01.png)");
        }
        ui->groupBox->show();
        ui->label_6->show();
    }
...
void game03::on_pushButton_3_clicked()
{
    this->close();
}


void game03::on_pushButton_4_clicked()
{
    ui->groupBox_2->show();
}


void game03::on_pushButton_11_clicked()
{
    ui->groupBox_2->close();
}
